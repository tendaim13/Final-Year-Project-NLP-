from corpus_unique import corpus_unique
import math
...
def unique_words(doc):
    ...
    for line in doc:
        ...
        article_list.append(cleaned_word.lower())
        cleaned_word = ""
...
def main():
    ...
    if choice == 2:
        line = input("Please paste the link to the website:\n")
    ...
    doc2 = open("Malay_14.24.01_unique_corpus.csv", "r")
    doc3 = open("Iban_14.24.01_unique_corpus.csv", "r")
    ...
    results_list = list(flat(similarity))

    if results_list[1] == results_list[2] or (results_list[1] < 0.150 and results_list[2] < 0.150):
        doc2 = open("Malay_14.24.01_revised_with_similar.csv", "r")
        doc3 = open("Iban_14.24.01_revised_with_similar.csv", "r")
    ...
    if(results_list[1] > results_list[2]):
        print("The Document is in MALAY")
    elif(results_list[2] > results_list[1]):
        print("The Document is in IBAN")
    else:
        print("Inconclusive")

    save_file = input("Please enter where you want the results to be saved: \n")
